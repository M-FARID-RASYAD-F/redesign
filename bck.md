{{--
    ...
    Cara pakai di Blade lain:
        <x-constellation-grid />

    Requirement:
        - Tailwind CSS sudah terpasang di project Laravel (via Vite/Mix)
        - Tidak butuh dependency JS tambahan, murni vanilla JS
--}}

<div
    x-data
    class="relative w-full h-screen overflow-hidden select-none bg-slate-950"
>
    <canvas id="constellation-canvas" class="absolute inset-0 block cursor-crosshair"></canvas>

    {{-- Overlay judul --}}
    <div class="relative z-10 flex h-full flex-col items-center justify-center text-center px-4 pointer-events-none mix-blend-difference text-white">
...
(function () {
    ...
    // Cleanup kalau elemen dilepas dari DOM (misal navigasi SPA/Turbo/Livewire)
