...
@section('title', 'Tulis Berita Baru - At-Tamam Edu')
...
<div class="header">
    <div>
        <h1 class="header-title">Tulis Berita Baru</h1>
...
<div class="card" style="max-width: 850px;">
    <form id="newsForm" action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" class="form-control" placeholder="Masukkan judul berita utama" required value="{{ old('title') }}">
            @error('title')
        ...
        <!-- Thumbnail Section (Upload Drag-and-Drop & URL Manual) -->
        <div class="form-group">
            ...
            <div id="uploadPane">
                ...
                <div class="dropzone-box" id="dropzoneBox">
                    ...
                    <div class="dropzone-title">Tarik & Lepas file gambar di sini, atau <span style="color: var(--adm-primary, #00B4D8); text-decoration: underline;">Pilih File</span></div>
            ...
            <div id="urlPane" style="display: none;">
                <input type="text" id="thumbnail" name="thumbnail" class="form-control" placeholder="Contoh: https://images.unsplash.com/... atau https://picsum.photos/800/400" value="{{ old('thumbnail') }}">
            ...
            <div class="thumbnail-preview-container" id="previewContainer">
                <img src="" alt="Pratinjau Thumbnail" id="previewImg" class="preview-img">
                <div class="preview-meta">
                    <div class="preview-filename" id="previewFilename">nama-file.jpg</div>
        ...
        <div class="form-group">
            ...
            <span style="font-size: 0.75rem; color: var(--text-muted);">Biarkan kosong untuk menjadikannya draft, atau tentukan waktu agar otomatis terbit.</span>
            @error('published_at')
                <div style="color: var(--danger); font-size: 0.8rem; margin-top: 4px;">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div style="display: flex; gap: 12px; margin-top: 28px;">
            <button type="submit" class="btn btn-primary" id="btnSubmitNews">Terbitkan Berita</button>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Isi konten dari old('content') jika ada
    ...
    fileInput.addEventListener('change', function () {
        if (fileInput.files && fileInput.files[0]) {
            ...
            urlInput.value = ''; // Kosongkan input URL jika upload file
        }
    });
    ...
    urlInput.addEventListener('input', function () {
        ...
        if (url) {
            ...
            fileInput.value = ''; // Kosongkan file jika input URL
        } else {
            clearPreview();
        }
    });

    // Jika old('thumbnail') ada
    if (urlInput.value.trim()) {
        showPreview(urlInput.value.trim(), urlInput.value.trim(), 'URL Eksternal');
    }
});
</script>
@endpush
