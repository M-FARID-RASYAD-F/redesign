...
<div class="card" style="max-width: 800px;">
    <form action="{{ route('admin.news.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" class="form-control" placeholder="Masukkan judul berita" required value="{{ old('title') }}">
            @error('title')
        ...
        <div class="form-group">
            ...
            <input type="text" id="thumbnail" name="thumbnail" class="form-control" placeholder="Masukkan link gambar atau biarkan kosong" value="{{ old('thumbnail') }}">
        ...
        <div class="form-group">
            ...
            <textarea id="content" name="content" class="form-control" rows="12" placeholder="Tulis isi berita selengkapnya disini..." required>{{ old('content') }}</textarea>
            @error('content')
                <div style="color: var(--danger); font-size: 0.8rem; margin-top: 4px;">{{ $message }}</div>
            @enderror
        </div>
