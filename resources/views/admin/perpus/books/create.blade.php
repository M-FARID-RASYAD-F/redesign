...
<div class="header" style="margin-bottom: 24px;">
    <div style="display: flex; align-items: center; gap: 12px;">
        ...
        <h1 class="header-title" style="font-size: 1.4rem; font-weight: 700; color: #1e293b; margin: 0;">Tambah Buku Baru</h1>
    </div>
</div>
    ...
    <form action="{{ route('admin.perpus.books.store') }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
            <div style="grid-column: span 2;">
                ...
                <input type="text" name="title" value="{{ old('title') }}" required placeholder="Masukkan judul lengkap buku" class="form-control" style="width: 100%; padding: 10px 12px; border-radius: 6px; border: 1px solid #cbd5e1;">
            </div>
            ...
            <div>
                ...
                <input type="text" name="isbn" value="{{ old('isbn') }}" placeholder="Contoh: 978-602-03-8591-4" class="form-control" style="width: 100%; padding: 10px 12px; border-radius: 6px; border: 1px solid #cbd5e1;">
            </div>
            ...
            <div>
                ...
                <input type="text" name="author" value="{{ old('author') }}" required placeholder="Nama penulis buku" class="form-control" style="width: 100%; padding: 10px 12px; border-radius: 6px; border: 1px solid #cbd5e1;">
            </div>

            <div>
                <label style="display: block; font-weight: 600; font-size: 0.875rem; color: #334155; margin-bottom: 6px;">Penerbit</label>
                <input type="text" name="publisher" value="{{ old('publisher') }}" placeholder="Nama penerbit / tahun terbit" class="form-control" style="width: 100%; padding: 10px 12px; border-radius: 6px; border: 1px solid #cbd5e1;">
            </div>
            ...
            <div>
                ...
                <input type="number" name="stock" value="{{ old('stock', 1) }}" min="1" required class="form-control" style="width: 100%; padding: 10px 12px; border-radius: 6px; border: 1px solid #cbd5e1;">
                <small style="color: #64748b; font-size: 0.775rem;">Stok awal otomatis mengisi jumlah 'Tersedia'.</small>
            </div>

            <div>
                <label style="display: block; font-weight: 600; font-size: 0.875rem; color: #334155; margin-bottom: 6px;">Lokasi Rak Fisik</label>
                <input type="text" name="rack_location" value="{{ old('rack_location') }}" placeholder="Contoh: Rak B-03, Lemari 2" class="form-control" style="width: 100%; padding: 10px 12px; border-radius: 6px; border: 1px solid #cbd5e1;">
            </div>
            ...
            <div style="grid-column: span 2;">
                ...
                <textarea name="synopsis" rows="4" placeholder="Ringkasan atau sinopsis singkat buku..." class="form-control" style="width: 100%; padding: 10px 12px; border-radius: 6px; border: 1px solid #cbd5e1; font-family: inherit;">{{ old('synopsis') }}</textarea>
            </div>
        </div>
