<header class="navbar">
    <div class="navbar-container">
        ...
        <ul class="nav-links">
            ...
            <li><a href="{{ route('ppdb.index') }}" class="nav-link" style="color: #60a5fa; font-weight: 800;">PPDB Online</a></li>
            <li><a href="{{ route('ppdb.tracking') }}" class="nav-link" style="color: #fde047; font-weight: 700;">Cek Status</a></li>
        </ul>
