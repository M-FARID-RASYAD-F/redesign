...
<div class="perpus-page-wrapper">
    <div class="perpus-container-medium">
        ...
        <div class="mb-10 sm:mb-14 flex flex-wrap items-center justify-between gap-6">
            <a href="{{ route('perpus.index') }}" class="perpus-btn-detail inline-flex items-center gap-3 px-6 py-3 text-sm font-semibold rounded-xl">
            ...
            <a href="{{ route('perpus.tracking') }}" class="perpus-btn-top-track">
            ...
            <div class="perpus-detail-grid">
                ...
                <div class="perpus-detail-cover-panel perpus-card-subsurface">
                    ...
                    <div class="perpus-stock-widget">
                        ...
                        <div class="perpus-stock-widget-status">
                        ...
                        <div class="perpus-stock-widget-total">Total Koleksi Sekolah: {{ $book->stock }} eksemplar</div>
                    </div>
                </div>
                ...
                <div class="perpus-detail-content-panel">
                    ...
                    <div class="perpus-detail-cta-bar">
                        @if($book->available > 0)
                        <a href="{{ route('perpus.pinjam.create', $book->id) }}" class="perpus-btn-borrow flex-1 text-center py-4 px-8 text-base font-bold">
                        ...
                        @else
                        <div class="flex-1 py-4 px-8 perpus-btn-disabled text-center font-bold">
                        ...
                        @endif
                        <a href="{{ route('perpus.index') }}" class="perpus-btn-detail px-8 py-4 text-center text-sm font-semibold">
                            Cari Buku Lain
                        </a>
                    </div>
                </div>
