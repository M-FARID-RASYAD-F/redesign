    ...
    <div class="perpus-container-narrow">
        ...
        <div class="perpus-card-surface p-6 sm:p-8 mb-8">
            <form action="{{ route('perpus.check') }}" method="POST" class="space-y-4">
                ...
                <button type="submit" class="perpus-btn-borrow w-full py-3.5 text-base flex items-center justify-center gap-2 font-bold cursor-pointer">
                ...
                <div class="perpus-stepper">
                    ...
                    <div class="perpus-step-item {{ $step >= 1 ? 'step-active' : '' }}">
                        ...
                        <div class="perpus-step-label">
                            <span class="block">Diajukan</span>
                            <span class="block text-[11px] opacity-75 font-normal">{{ $loan->created_at->format('d M Y') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="perpus-step-item {{ $loan->status === 'terlambat' ? 'step-warning' : ($step >= 2 ? 'step-active' : '') }}">
                        ...
                        <div class="perpus-step-label">
                            <span class="block">{{ $loan->status === 'terlambat' ? 'Terlambat' : 'Dipinjam' }}</span>
                            <span class="block text-[11px] opacity-75 font-normal">
                    ...
                    <div class="perpus-step-item {{ $step >= 3 ? 'step-active' : '' }}">
                        ...
                        <div class="perpus-step-label">
                            <span class="block">Dikembalikan</span>
                            <span class="block text-[11px] opacity-75 font-normal">
            ...
            <div class="p-6 sm:p-8 space-y-6 pt-2">
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5 p-5 rounded-2xl perpus-card-subsurface">
                    <div class="w-24 h-32 rounded-xl overflow-hidden shrink-0 shadow-lg border border-white/10 flex items-center justify-center bg-slate-900/60">
                        ...
                        @else
                            <div class="text-center p-2 text-slate-500">
                                <svg class="w-8 h-8 mx-auto mb-1 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        ...
                        <h3 class="font-bold text-white text-lg sm:text-xl mb-1 leading-snug">
                            {{ $loan->book->title }}
                        </h3>
                        ...
                        <a href="{{ route('perpus.show', $loan->book->id) }}" class="inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-400 hover:text-emerald-300 transition-colors">
                ...
                <div class="pt-4 border-t border-white/10 flex flex-col sm:flex-row gap-3">
                    <button type="button" onclick="window.print()" class="flex-1 py-3 px-4 rounded-xl bg-white/10 hover:bg-white/15 text-white font-semibold text-sm flex items-center justify-center gap-2 border border-white/15 transition-all">
                        <svg class="w-4 h-4 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg>
                        <span>Cetak Bukti Lacak</span>
                    </button>
                    @if($loan->status === 'diajukan')
                    <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Perpustakaan,%20saya%20sudah%20mengajukan%20peminjaman%20dengan%20kode%20{{ $loan->loan_code }}%20untuk%20buku%20{{ urlencode($loan->book->title) }}" target="_blank" rel="noopener noreferrer" class="flex-1 py-3 px-4 rounded-xl bg-emerald-600/30 hover:bg-emerald-600/40 text-emerald-300 font-semibold text-sm flex items-center justify-center gap-2 border border-emerald-500/40 transition-all">
